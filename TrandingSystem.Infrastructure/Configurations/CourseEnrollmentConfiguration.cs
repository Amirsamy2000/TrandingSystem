...
{
    public partial class CourseEnrollmentConfiguration : IEntityTypeConfiguration<CourseEnrollment>
    {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<CourseEnrollment> entity);
    }
}
