...
{
    public partial class CourseLecturerConfiguration : IEntityTypeConfiguration<CourseLecturer>
    {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<CourseLecturer> entity);
    }
}
