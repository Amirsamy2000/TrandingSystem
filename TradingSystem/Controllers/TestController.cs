...
namespace TrandingSystem.Controllers
{
    public class TestController : Controller
    {
        ...
        private readonly IWasabiUploader wasabiUploader;
        public TestController(IStringLocalizer<ValidationMessages> localizer, IWasabiUploader _wasabiUploader)
        {
            _localizer = localizer;
            wasabiUploader = _wasabiUploader;
        }
